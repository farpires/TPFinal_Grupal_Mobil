...
import com.example.tpfinal_grupal_mobil.entidades.entornodedatosdistribuidora;
...
public class distribuidoraabm extends AppCompatActivity implements View.OnClickListener{
    ...
    public void onClick(View v)
    {
        if (v.getId()==distribuidoraBotonAgregar.getId())
        {
            ...
            RutaAlServicioWEB = entornodedatosdistribuidora.AgregarParametroALink(RutaAlServicioWEB,"&DatosEnFormatoJSON",SalidaDeObjetoEnFormatoJson);
